    ...
    <div class="login-box">
        ...
        <div v-if="type=='signin'">
            <form class="login-form" ref="formSignIn">
                ...
                <input type="submit" value="立即登录" class="login-input" @click="handleSignIn"/>
            </form>
            <div class="login-footer">
                <div>
                    <input type="checkbox" id="remember"/><label for="remember" v-model="form.rememberChecked" @click="RememberCheck">记住我</label> 
                </div>
                <a href="">忘记密码？</a>
            </div>
        </div>
